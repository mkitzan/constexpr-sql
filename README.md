...
It is strongly recommended to compile with optimizations enabled, otherwise expect template bloat. Also, there are more examples and information in [`presentation.pdf`](https://github.com/mkitzan/constexpr-sql/blob/master/presentation.pdf) at the root of the repo.
